...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { first: @name.first, last: @name.last, middle: @name.middle, person_id: @name.person_id, prefix: @name.prefix, suffix: @name.suffix }
    end
  ...
  test "should update name" do
    patch :update, id: @name, name: { first: @name.first, last: @name.last, middle: @name.middle, person_id: @name.person_id, prefix: @name.prefix, suffix: @name.suffix }
    assert_redirected_to name_path(assigns(:name))
  end
